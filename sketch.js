...
function preload(){
  ...
  c=loadAnimation("a/1.png","a/2.png","a/3.png","a/4.png","a/5.png","a/6.png")
}
...
function setup() {
  ...
  creditButton=createSprite(1850,850,100,100);
  ...
  knight = new Knight(100,100,250,150);

  ground1 = new Ground(width/2,900,width,500);
...
if(gamestate==="level1"){
  ...
  if(keyDown("RIGHT_ARROW")){
    knight.body.position.x=knight.body.position.x+10
  }
